<x-app-layout>
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right">
                            ...
                            <x-modal name="edit-komoditas-{{ $k->id }}" focusable>
                                <form method="post" action="{{ route('komoditas.update', $k->id) }}" class="p-6 text-left">
                                    @csrf
                                    @method('put')
                            ...
                            <x-modal name="hapus-komoditas-{{ $k->id }}" focusable>
                                <form method="post" action="{{ route('komoditas.destroy', $k->id) }}" class="p-6 text-left">
                                    @csrf
                                    @method('delete')
    ...
    <x-modal name="tambah-komoditas" focusable>
        <form method="post" action="{{ route('komoditas.store') }}" class="p-6">
            @csrf
